...
| G13 | Shared guard dispatcher + terminal handling | `apps/arbiter/lib/arbiter/worker/review_gate.ex:2694` (`run_verdict_guard`), `apps/arbiter/lib/arbiter/worker/review_gate.ex:2823` (`fail_closed`), registry `apps/arbiter/lib/arbiter/worker/review_gate.ex:2746` (`verdict_guards`) | Four guards drifting apart | — | — | — |
