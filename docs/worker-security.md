...
| `:no_public_upload`  | public upload/paste hosts, `gh gist create`/`edit`, `gh issue comment` |

### Public upload and paste hosts (`:no_public_upload`, bd-80talz)
...
`gh pr comment` stays allowed: the review-thread follow-up protocol uses it.
