defmodule GtElixirCli.Cmd.Create do
  @moduledoc """
  `bd2 create <title> [--description ...] [--priority N] [--type T]
                       [--deps id1,id2] [--labels a,b] [--assignee a]`

  Creates a new issue in the resolved workspace (see `GtElixirCli.Workspace`).
  ...
  in place — the failure is reported and bd2 exits non-zero.
