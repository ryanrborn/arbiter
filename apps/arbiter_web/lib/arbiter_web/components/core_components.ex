defmodule ArbiterWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ArbiterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ArbiterWeb.Gettext, "errors", msg, opts)
    end
  end
