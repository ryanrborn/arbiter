defmodule Arbiter.Beads.IssueProgressTest do
  @moduledoc """
  Unit coverage for the unified parent-with-progress concept: a bead's
  ...
  describe "child-progress calculations" do
    ...
    test "a leaf bead has zero children", %{ws: ws} do
