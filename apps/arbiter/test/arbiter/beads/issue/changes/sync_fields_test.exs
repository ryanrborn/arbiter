defmodule Arbiter.Beads.Issue.Changes.SyncFieldsTest do
  @moduledoc """
  ...
  describe "title change on a github-tracked bead" do
  ...
  describe "description change on a github-tracked bead" do
