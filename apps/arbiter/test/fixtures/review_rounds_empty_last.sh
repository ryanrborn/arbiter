...
# backstop.
verdict="${1:-APPROVE}"
M1="$(git rev-parse --git-common-dir)/rounds_empty_last_m1"
M2="$(git rev-parse --git-common-dir)/rounds_empty_last_m2"
M3="$(git rev-parse --git-common-dir)/rounds_empty_last_m3"
M4="$(git rev-parse --git-common-dir)/rounds_empty_last_m4"
