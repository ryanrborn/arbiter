...
verdict="${1:-APPROVE}"
M1="$(git rev-parse --git-common-dir)/trib_retry_reset_m1"
M2="$(git rev-parse --git-common-dir)/trib_retry_reset_m2"
M3="$(git rev-parse --git-common-dir)/trib_retry_reset_m3"
