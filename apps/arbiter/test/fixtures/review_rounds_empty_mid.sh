...
# backstop.
verdict="${1:-APPROVE}"
marker1="$(git rev-parse --git-common-dir)/rounds_empty_mid_pass1"
marker2="$(git rev-parse --git-common-dir)/rounds_empty_mid_pass2"
marker3="$(git rev-parse --git-common-dir)/rounds_empty_mid_pass3"
