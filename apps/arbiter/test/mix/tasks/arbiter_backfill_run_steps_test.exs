defmodule Mix.Tasks.Arbiter.BackfillRunStepsTest do
  ...
  @source File.read!("lib/mix/tasks/arbiter.backfill_run_steps.ex")
  ...
  test "does not boot the full application" do
    ...
    assert @run_body =~ "Arbiter.Release.backfill(:run_steps",
  ...
  test "documents the release eval invocation" do
    ...
    assert @source =~ "Arbiter.Release.backfill(:run_steps"
  end
end
