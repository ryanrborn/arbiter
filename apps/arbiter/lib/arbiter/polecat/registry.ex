defmodule Arbiter.Polecat.Registry do
  @moduledoc """
  Thin wrapper exposing the `:via` tuple used to register `Arbiter.Polecat`
  ...
  @doc """
  Return the `:via` tuple a `Arbiter.Polecat` GenServer registers under for
  the given `bead_id`.
  """
