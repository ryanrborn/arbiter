defmodule ArbiterCli.AliasResolver do
  ...
  @known_verbs ~w(init show create close reopen list update dep ready doctor start restart where help sling prime polecat inbox notify message msg claim sync usage convoy config)
