defmodule ArbiterCli.AliasResolver do
  ...
  # `issue dispatch`).
  @known_verbs ~w(issue worker repo dep config server workspace message usage loop queue quota install mcp skill dispatch prime where init help version self-update upgrade)
