defmodule GtElixir.Polecat.BranchNamer do
  @moduledoc """
  Derive a git branch name from a `GtElixir.Beads.Issue` following the Verus
  naming convention:
  ...
  def derive(other) do
    raise ArgumentError,
          "BranchNamer.derive/1 expected %GtElixir.Beads.Issue{}, got: #{inspect(other)}"
  end
