defmodule GtElixir.Polecat.ClaudeSession do
  @moduledoc """
  Port wrapper that runs a child process (eventually Claude Code CLI) inside a
  worktree and streams its stdout into a parent `GtElixir.Polecat` GenServer.
  ...
  defp broadcast(%{topic: topic}, msg) when is_binary(topic) do
    ...
    _ = Phoenix.PubSub.broadcast(GtElixir.PubSub, topic, msg)
    :ok
  end
