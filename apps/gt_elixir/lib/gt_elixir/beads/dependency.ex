defmodule GtElixir.Beads.Dependency do
  @moduledoc """
  ...
  * Both FKs (`from_issue_id`, `to_issue_id`) must reference real `Issue` rows.
  ...
  actions do
    ...
    create :create do
      ...
      change {GtElixir.Beads.Dependency.Changes.RejectSelfReference, []}
    end
  ...
  relationships do
    belongs_to :from_issue, GtElixir.Beads.Issue do
      allow_nil? false
      public? true
    ...
    belongs_to :to_issue, GtElixir.Beads.Issue do
      allow_nil? false
      public? true
      attribute_writable? true
      attribute_type :string
