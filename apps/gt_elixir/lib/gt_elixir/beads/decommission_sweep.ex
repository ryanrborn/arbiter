defmodule GtElixir.Beads.DecommissionSweep do
  @moduledoc """
  One-time sweep to bulk-close beads orphaned by the GT → gt-elixir
  ...
  Beads on the keep list are skipped even if they match a pattern:
    ...
    * `gte-026`, `gte-027`, `gte-028` — gt-elixir cutover process beads,
  ...
  def gt_system?(%Issue{title: t}) when is_binary(t) do
    ...
    # gt-elixir port (e.g. "gt-elixir", "gte-").
    cond do
