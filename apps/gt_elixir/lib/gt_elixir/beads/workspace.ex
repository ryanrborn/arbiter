defmodule GtElixir.Beads.Workspace do
  @moduledoc """
  ...
  vernacular + `:none` tracker. See `~/dev/gt-elixir/docs/decision-doc.md` sections
  ...
  @valid_tracker_types ~w(none jira linear github)
