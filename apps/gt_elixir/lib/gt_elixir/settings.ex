defmodule GtElixir.Settings do
  @moduledoc """
  ...
  def get do
    case Ash.read_one(__MODULE__, domain: GtElixir.Beads) do
      {:ok, nil} -> Ash.create(__MODULE__, %{vernacular: %{}}, domain: GtElixir.Beads)
  ...
  def update_vernacular(settings, vernacular) when is_map(vernacular) do
    Ash.update(settings, %{vernacular: vernacular}, domain: GtElixir.Beads)
  end
end
