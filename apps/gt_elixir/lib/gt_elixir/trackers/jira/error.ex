defmodule GtElixir.Trackers.Jira.Error do
  @moduledoc """
  Normalised error returned by every `GtElixir.Trackers.Jira` function on
  failure. Mirrors the shape of `GtElixir.GitHub.Error` for consistency.
