defmodule GtElixir.Workflows.MachineRegistry do
  @moduledoc """
  Thin wrapper around the `Registry` named `GtElixir.Workflows.MachineRegistry`,
  used to key running `GtElixir.Workflows.Machine` processes by their
  MachineState id (a UUID v7 string).

  The Registry itself is started by `GtElixir.Application`.
  """
