defmodule GtElixir.Workflows.CodeReview.GithubMode do
  @moduledoc """
  GitHub-mode side-effects for `GtElixir.Workflows.CodeReview`.

  Wraps `GtElixir.GitHub` calls used by the workflow:
