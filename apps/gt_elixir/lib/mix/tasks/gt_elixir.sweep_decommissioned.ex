defmodule Mix.Tasks.GtElixir.SweepDecommissioned do
  @shortdoc "Bulk-close beads obsoleted by the GT → gt-elixir cutover"
  @moduledoc """
  Bulk-close beads orphaned by the cutover from the original Go GT system.
  See `GtElixir.Beads.DecommissionSweep` for the pattern list and the
  keep-list.

  ## Usage

      mix gt_elixir.sweep_decommissioned                # dry-run
      mix gt_elixir.sweep_decommissioned --apply        # actually close
  ...
  alias GtElixir.Beads.DecommissionSweep
