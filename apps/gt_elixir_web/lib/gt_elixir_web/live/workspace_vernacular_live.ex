defmodule GtElixirWeb.WorkspaceVernacularLive do
  @moduledoc """
      ...
      <div class="grid grid-cols-2 gap-6">
        ...
        <div>
          ...
          <table class="table table-sm">
            ...
            <tbody>
              <%= for key <- GtElixir.Vernacular.keys() do %>
                <tr>
                  <td><code class="text-xs">{Atom.to_string(key)}</code></td>
                  <td>
                    {Map.get(@preview, Atom.to_string(key), GtElixir.Vernacular.defaults()[key])}
                  </td>
                </tr>
              <% end %>
            </tbody>
